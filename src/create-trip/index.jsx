...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    if(formDate?.noOfDays > 5 && !formDate?.location || !formDate?.budget || !formDate?.traveler || !formDate?.noOfDays || !formDate?.location) {
  ...
  return (
    <><div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10'>
      ...
      <p className='mt-3 text-gray-500 text-xl'>Just provide some basic information, and our trip planner will generate a costomized itinerary on your preferences.</p>
      ...
      <div>
        ...
        <div className='grid grid-cols-3 gap-5 mt-5'>
          {SelectBudgetOptions.map((item, index) => (
            ...
            ${formDate?.budget == item.title && 'shadow-lg bg-rose-100 border-black'}`}
      ...
      <div>
        ...
        <div className='grid grid-cols-3 gap-5 mt-5'>
          {SelectTravelsList.map((item, index) => (
            <div key={index} className={`p-4 border cursor-pointer rounded-lg hover:shadow-lg 
            ${formDate?.traveler == item.people && 'shadow-lg bg-fuchsia-100 border-black'}`}
